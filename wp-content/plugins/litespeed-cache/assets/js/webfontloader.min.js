! function() {
    ...
    function C(t, n) {
        this.c = t, this.f = n, this.a = c(this.c, "span", {
            "aria-hidden": "true"
        }, this.f)
    }
    ...
    D.prototype.g = function(t) {
        ...
        this.c = new n(this.j, t.context || this.j), this.g = !1 !== t.events, this.f = !1 !== t.classes,
            function(o, t, n) {
                var i = [],
                    e = n.timeout;
                        ...
                        if (0 === h.length && p) k(c.a);
                            ...
                            for (i = 0; i < h.length; i++) {
                                var o = h[i],
                                    ...
                                    s = c.a,
                                    r = o;
                                if (s.g && g(s.f, [s.a.c("wf", r.c, x(r).toString(), "loading")]), T(s, "fontloading", r), (s = null) === $)
                                    if (window.FontFace) {
                        ...
                        for (var r, f = (r = r.split(",")).length, c = 0; c < f; c++) {
                            ...
                            if ((h = r[c]).match(/^[\w-]+$/))
                                if (null == (u = V.exec(h.toLowerCase()))) h = "";
                                    ...
                                    if (h = null == (h = u[2]) || "" == h ? "n" : U[h], null == (u = u[1]) || "" == u) u = "4";
                                    else var l = R[u],

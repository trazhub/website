    ...
    var e = {
                ...
                function a() {
                    ...
                    e.each(function() {
                        ...
                        if (t(this).hasClass("wpr-mega-menu-width-full")) e.css({
                            ...
                            let a = t(this).closest(".elementor-section");
                            a = a.hasClass("elementor-inner-section") ? a : a.children(".elementor-container");
                            let r = a.hasClass("elementor-inner-section") ? "0" : a.find(".elementor-element-populated").css("padding");
                            r = parseInt(r.replace("px", ""), 10);
                            let s = a.outerWidth() - 2 * r,
                ...
                t(document).ready(function() {
                    ...
                    i.each(function() {
                        ...
                        t(this).click(function(e) {
                            e.preventDefault(), i.removeClass("wpr-onepage-active-item"), t(this).addClass("wpr-onepage-active-item");
            ...
            widgetGrid: function(a) {
                ...
                function l(e) {
                    ...
                    if ("fitRows" === e.layout && 1 < s) {
                        let e = Math.max.apply(null, r.map(function() {
                ...
                if (h.length) {
                    ...
                    if (V.observe(a[0], {
                        ...
                        var N = h.find(".wpr-grid-item-add-to-cart").find("i"),
                            H = N.attr("class");
                        N.length && (H = H.substring(H.indexOf("fa-"), H.length)), t("body").on("adding_to_cart", function(e, t) {
                            t.fadeTo("slow", 0)
                            ...
                            if (s.next().fadeTo(700, 1), s.css("display", "none"), "sidebar" === s.data("atc-popup")) t(".wpr-mini-cart-toggle-wrap a").length && t(".wpr-mini-cart-toggle-wrap a").each(function() {
                                ...
                                var o = s.closest(".wpr-grid-item"),
                                    ...
                                    h, g;
                                "slide-left" === c ? (m = "wpr-added-to-cart-slide-in-left", g = "wpr-added-to-cart-slide-out-left") : "scale-up" === c ? (m = "wpr-added-to-cart-scale-up", g = "wpr-added-to-cart-scale-down") : "skew" === c ? (m = "wpr-added-to-cart-skew", g = "wpr-added-to-cart-skew-off") : "fade" === c ? (m = "wpr-added-to-cart-fade", g = "wpr-added-to-cart-fade-out") : g = "wpr-added-to-cart-popup-hide", h = "" === p ? "" : "<div class=\"wpr-added-tc-popup-img\"><img src=" + p + " alt=\"\" /></div>", 0 < a.find(".wpr-grid").find("#wpr-added-to-cart-" + n).length || (a.find(".wpr-grid").append("<div id=\"wpr-added-to-cart-" + n + "\" class=\"wpr-added-to-cart-popup " + m + "\">" + h + "<div class=\"wpr-added-tc-title\"><p>" + d + " was added to cart</p><p><a href=" + l + ">View Cart</a></p></div></div>"), setTimeout(() => {
                                    t(this).find("#wpr-added-to-cart-" + n).addClass(g), setTimeout(() => {
                                        t(this).find("#wpr-added-to-cart-" + n).remove()
                                    }, 1e3 * w)
                                }, 1e3 * f))
                            }
                            N.length && (s.find("i").removeClass(H).addClass("fa-check"), setTimeout(function() {
            ...
            widgetSearch: function(i) {
                ...
                i.find(".wpr-search-form-input").on({
                    ...
                    e && i.find(".wpr-category-select option").each(function() {
                        return console.log(t(this).val()), t(this).val() === e ? (r = !0, i.find(".wpr-category-select").val(e), !1) : void i.find(".wpr-category-select").val(0)
                    })
            ...
            widgetOffcanvas: function(i) {
                ...
                if (i.hasClass("wpr-offcanvas-entrance-animation-pro-sl") ? i.removeClass("wpr-offcanvas-entrance-animation-pro-sl").addClass("wpr-offcanvas-entrance-animation-fade") : i.hasClass("wpr-offcanvas-entrance-animation-pro-gr") && i.removeClass("wpr-offcanvas-entrance-animation-pro-gr").addClass("wpr-offcanvas-entrance-animation-fade"), i.hasClass("wpr-offcanvas-entrance-type-pro-ps") && i.removeClass("wpr-offcanvas-entrance-type-pro-ps").addClass("wpr-offcanvas-entrance-type-cover"), i.hasClass("wpr-offcanvas-entrance-type-push")) {
                    ...
                    function s() {
                        r(o), o.find(".wpr-offcanvas-content").hasClass("wpr-offcanvas-content-left") ? n.css({
                    ...
                    }), "yes" === i.find(".wpr-offcanvas-container").data("offcanvas-open") && i.find(".wpr-offcanvas-trigger").trigger("click"), l();
                    var d = new MutationObserver(function() {
                        l()
                    });
                    d.observe(i[0], {
                                ...
                                Promise.all(h.map(e => {
                                    ...
                                    var s = h.map(i => {
                                        if ("redirect" !== i) {
                                            ...
                                            if (a && "success" === a.data.status) {
                                                if (l.push("success"), r) return e(r, i, "success", s);
                                            } else if (l.push("error"), r) return e(r, i, "error", s)
                                        }
                                    });
                                    return Promise.all(s).then(() => {
                                        l.includes("error") ? i.find("form").append("<p class=\"wpr-submit-error\">" + i.data("settings").error_message + "</p>") : (i.find("form").append("<p class=\"wpr-submit-success\">" + i.data("settings").success_message + "</p>"), i.find("button").attr("disabled", !0), i.find("button").css("opacity", .6))
                                    })
                                }).catch(e => {
                                    console.error(e)
                                }).then(() => {
                                    setTimeout(function() {
                                        i.find(".wpr-button").find(".wpr-double-bounce").addClass("wpr-loader-hidden"), i.find(".wpr-button>span").removeClass("wpr-loader-hidden"), setTimeout(function() {
                                            h.includes("redirect") && l.includes("success") && t(location).prop("href", i.find(".wpr-form-field-type-submit").data("redirect-url"))
                                        }, 500)
                                    }, 500)
                                }).catch(e => {
                                    console.error(e)

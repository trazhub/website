...
<body style="" class="b" style="background-color: #50A6D9;">
    <!-- Modal -->
                ...
                <div class="modal-body p-4">
                    <form action="index.php" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <input required type="text" id="name2" class="form-control" />
                            <label class="form-label" for="name2">Name</label>
                        </div>

                        <!-- Email input -->
                        <div class="form-outline mb-4">
                            <input required type="email" id="email2" class="form-control" />
                        ...
                        <div class="form-outline mb-4">
                            <input required type="email" id="email2" class="form-control" />
                            <label class="form-label" for="email2">City</label>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <input required type="email" id="email2" class="form-control" />
                            <label class="form-label" for="email2">Pincode</label>
                        </div>
                        <!-----service-->
                        <div class="form-check form-check-inline">
                            <input required class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" />
                            <label class="form-check-label" for="inlineCheckbox1">Dry Cleaning</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input required class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2" />
                            <label class="form-check-label" for="inlineCheckbox2">Laundry </label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input required class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3" />
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-block" name="btn">Place Order</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar- bg-li " style="background-color: #50A6D9;">
        <div class="container-fluid">

            <!-- Navbar brand -->
            <a class="navbar-brand me-2" href="https://mdbgo.com/">
                <img src="img/logo/cover.png" height="120" alt="MDB Logo" loading="lazy" style="margin-top: -1px; margin-left: -3rem; " />
            </a>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <button class="navbar-toggler btn-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation" style="background-color: #ffff; color: #50A6D9;">
                <i class="fas fa-align-justify"></i>
            </button>
            <div class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="background-color: #50A6D9 ;">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel"></h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body" style="background-color: #50A6D9;">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#" tabindex="-1" style="; font-size: 1.5rem;"> <i class="fas fa-handshake"></i> Franchise</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#" tabindex="-1" style="color:black; font-size: 1.5rem;"> <i class="fas fa-align-center"></i> Bulk Order</a>
                        </li>
                        <li class="nav-item">
  ...
  <div id="carouselExampleInterval" class="carousel slide" data-mdb-ride="carousel">
    ...
    <div class="container-flude" style="background-color: #50A6D9; height: 150px;">
        <div class="row">
    ...
    <section class="section-services" style="background-color: #50A6D9; ">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 pt-5">
                                            <button type="submit" class="btn btn-white bg-white  btn-block mb-4" style="color: #50A6D9; font-weight: bolder;" name="btn">Place order</button>
                                        </div>
        ...
        <div class="container-flude mt-4 p- services-cont">
                ...
                <div class="pro-container ">
                    ...
                    <div class="card-pro ">
                        ...
                        <div class="face face2">
                            <div class="content">
                                <p>Dry cleaning employs chemical solvents for cleaning, ideal for garments and fabrics unsuitable for water wash, effectively eliminating stains and odors.</p>
                                <a href="#">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-pro">
                        ...
                        <div class="face face2">
                            <div class="content">
                                <p>For the time-strapped, wash and iron services provide a convenience blend, granting clean, fresh, and wrinkle-free garments, liberating time.</p>
                                <a href="#">Read More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-pro">
                        ...
                        <div class="face face2">
                            <div class="content">
                                <p>"Fluff and fold" or drop-off laundry services, known as wash and fold, offer a hassle-free solution for outsourcing laundry, saving time and effort.</p>
                                <a href="#">Read More</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Jumbotron -->
        <div class="p-4 mt-5 " style="margin-top: -1rem; margin-bottom: -1rem; border: #ffff solid rem;">

            <div class="row ">
                <div class="col-md-2"></div>
                <div class="col-md-8 col-12 about-home-cont">
                    <h2 class=" text-center home-about-ban-hed text-white">About laundrywalah
        ...
        <span class="letter">y</span>--->
                    ...
                    <p class="fs-5 text-justify home-about-ban-p pt-5 text-white text-center ">
                        Laundrywalah, a renowned franchise chain, excels in high-quality laundry and dry cleaning. Our proficient team meticulously tends to your garments, ensuring they emerge clean, fresh, and impeccably pressed. We've made laundry and dry cleaning accessible
                        to all, never compromising on quality while emphasizing swiftness and affordability.
                    </p>


                    <p class="fs-5 te text-justify home-about-ban-p text-white text-center ">
                        We value your time and prioritize your convenience, offering swift, dependable, and personalized services. Whether you require "wash and fold," "dry cleaning," or "specialty laundry" solutions, Laundrywalah delivers skill and dependability. Experience
                        the transformative power of exceptional care and service at our establishment.
                    </p>
                    <div class="row pb-5">
                        <div class="col-md-5 col-4"></div>
                        <div class="col-md-7 col-8">
                            <button type="button" class="btn btn-primary bg-white pl-3 ml-4 " style="float: center;color: #50A6D9; font-weight: bolder;" data-mdb-toggle="modal" data-mdb-target="#staticBackdrop2">
                                Read More
                            </button>
                        </div>
                    </div>
...
<!-- Carousel wrapper -->
        ...
        <div class=" shadow-4 rounded-3 mt-3 container" style="background-color: transparent;">
            <div class="row  ">
                <div class="col-md-6 ">
                    ...
                    <p style="text-justify: auto;">Laundrywalah is your comprehensive answer for all your laundry requirements. Explore why we stand as India's premier laundry service provider and why customers place their trust in us for their laundry needs.</p>
                ...
                <div class="col-md-6 mt-3 ">
                    <div> <i class="fas fa-arrow-down-short-wide fa-2x text-Success  " style="margin-left: rem; display: inline-block; float: left;"></i>
                        <h6 style="display: inline-block; float:left;"> 01. Shorting</h6>
                    </div><br>
                    ...
                    <div> <i class="fas fa-viruses fa-2x text-Success p-2" style="margin-top: rem;  display: inline-block; float: left;"></i>
                        <h6 style="display: inline-block; float:left;">02. Stain Treatment</h6>
                    </div>
                    <div class="" style="margin-left: 3rem; display: inline-block; text-justify: auto;">
                    ...
                    <div> <i class="fas fa-hot-tub-person fa-2x text-Success p-2" style="margin-left: rem; display: inline-block; float: left;"></i>
                        <h6 style="display: inline-block; float:left;">03. Washing</h6>
                    </div>
                    <div class="" style="margin-left: 3rem; display: inline-block; text-justify: auto;">
                    ...
                    <div> <i class="fas fa-person-booth fa-2x text-Success p-2" style="margin-left: rem; display: inline-block; float: left;"></i>
                        <h6 style="display: inline-block; float:left;">04. Drying</h6>
                    </div>
                    <div class="" style="margin-left: 3rem; display: inline-block; text-justify: auto;">
                    ...
                    <div> <i class="fas fa-box-open fa-2x text-Success p-2" style="margin-left: rem; display: inline-block; float: left;"></i>
                        <h6 style="display: inline-block; float:left;">05. Folding & Packaging</h6>
                    </div>
                    <div class="" style="margin-left: 3rem; display: inline-block; text-justify: auto;">
                    ...
                    <div> <i class="fas fa-truck-fast fa-2x text-Success p-2" style="margin-left: rem; display: inline-block; float: left;"></i>
                        <h6 style="display: inline-block; float:left;"> 06. Ready For delivery</h6>
                    </div>
                    <div class="" style="margin-left: 3rem; display: inline-block; text-justify: auto;">
    ...
    <!-- Jumbotron -->
    <div class="p-4 shadow-4 rounded-3 mt-3 container-fluid" style="background-color: #50A6D9;">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="img/Affordable Pricing.jpg" alt="Trendy Pants and Shoes" class="img-fluid rounded-start" style="height: 100%; width: 100%;" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="img/High Quality.jpg" alt="Trendy Pants and Shoes" class="img-fluid rounded-start" style="height: 100%; width: 100%;" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="img/Personalized Experience.jpg" alt="Trendy Pants and Shoes" class="img-fluid rounded-start" style="height: 100%; width: 100%;" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="img/Instant Order Update.jpg" alt="Trendy Pants and Shoes" class="img-fluid rounded-start" style="height: 100%; width: 100%;" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="img/Convenience.jpg" alt="Trendy Pants and Shoes" class="img-fluid rounded-start" style="height: 100%; width: 100%;" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="img/Express Delivery.jpg" alt="Trendy Pants and Shoes" class="img-fluid rounded-start" style="height: 100%; width: 100%;" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
    ...
    <footer class="bg-info text-white">
        ...
        <div class="container p-4">
            ...
            <section class="mb-4">
                <!-- Facebook -->
                <!-- Facebook -->
                <a class="btn text-white  " style="background-color: transparent;" href="https://www.facebook.com/profile.php?id=61552302774175" role="button"><i class="fab fa-facebook-f" style="background-color: transparent;"></i></a>

                <!-- Twitter -->
                <a class="btn text-white  m-1" style="background-color: #55acee;" href="https://www.x.com/laundrywalah" role="button"><i class="fab fa-twitter"></i></a>

                <!-- Google -->
                <a class="btn text-white  m-1" style="background-color: #dd4b39;" href="#!" role="button"><i class="fab fa-google"></i></a>

                <!-- Instagram -->
                <a class="btn text-white  m-1" style="background-color: #ac2bac;" href="https://www.instagram.com/laundrywalah" role="button"><i class="fab fa-instagram"></i></a>

                <!-- Linkedin -->
                <a class="btn text-white  m-1" style="background-color: #0082ca;" href="#!" role="button"><i class="fab fa-linkedin-in"></i></a>
            </section>
            <!-- Section: Social media -->

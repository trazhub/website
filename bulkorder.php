  ...
  <ul class="navbar-nav mr-auto ">
   ...
   <!----<li class="nav-item dropdown">
    ...
    <div class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="background-color:#1D1F2B ;">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="#bulkorder"  tabindex="-1" style="color:black; font-size: 1.5rem;"> <i class="fas fa-align-center"></i> Bulk Order</a>
    </li>
    <li class="nav-item">
...
<div class="container-flude bg-home-banner" style="
 ...
 ">
  <div class="row" style="background-color:#1D1F2B; opacity:0.6 ; height: 350px;" >
      ...
      <div class="card shadow-5 p" style="border-radius: 15px; border: 2px solid whitesmoke; box-shadow: 2px; background-color: transparent; ">
       <div class="row">
         <div class="col-sm-12 col-lg-12 p-3">
           <h2 class="mt-3 text-white">Schedule Bulk Pickup</h2>
           <form action="" method="post">
            <!-- 2 column grid layout with text inputs for the first and last names -->
            <div class="row g-3 mb-3">
                <div class="col-sm-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 pt-5">
                    <button type="submit" class="btn btn-white   btn-block mb-4" style="color:#ffff; font-weight: bolder; background-color:#FE8400;" name="btn">Place Bulk order</button>
                </div>
